...
extern "C" {
int bare_worklet_android_attach_vm(bare_worklet_t *worklet, JavaVM *java_vm);
}
...
static int configureAndroidWorklet(bare_worklet_t *worklet, void *data) {
...
BareKitModule::BareKitModule(std::shared_ptr<CallInvoker> jsInvoker)
    : BareKitModule(std::move(jsInvoker), configureAndroidWorklet, currentJavaVm()) {}
